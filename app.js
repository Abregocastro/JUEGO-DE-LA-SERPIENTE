document.addEventListener('DOMContentLoaded', () => {
    ...
    const startGame = () => {
        ...
        grid.style = (stopGame ? "background-color:wheat" : "background-color:rgb(230, 245, 255)")
    }
    ...
    grid.addEventListener('click', () => {
        if (!stopGame)
            ...
            interval = setInterval(moveOutcomes, intervalTime)
        grid.style = (stopGame ? "background-color:rgb(230, 245, 255)" : "background-color:wheat")
